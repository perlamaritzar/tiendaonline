    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <p>Bienvenid@ a PCland.</p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <p style="font-size: 20px; color: #000000">Nuevos Productos:</p>
                <p style="font-size: 18px;"><strong>Equipos:</strong></p>
                <li>Laptop Gamer Lenovo IdeaPad Gaming 3 15ARH7 15.6" Full HD, AMD Ryzen 5 6600H</li>
                <li>Laptop Gamer Lenovo LOQ 16APH8 16" WUXGA, AMD Ryzen 7 7840HS</li>
                <li>Laptop Gamer MSI Katana A15 AI B8VG 15.6" Full HD, AMD Ryzen 7 8845HS 3.80GHz</li>
                <li>Laptop Gamer Alienware AM16 R2 16" Quad HD, Intel Core Ultra 7-155H 3.80GHz</li>
                <p></p>
            </div>
        </div>
    </div>
