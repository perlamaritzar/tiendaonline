    ...
    <div class="col-12" style="padding: 5px;">
        <div style="background-color: white; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 10px; border-radius: 10px;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <p style="font-size: 20px; color: #125e2b; margin-bottom: 0;">Formulario para creación de nueva producto.</p>
            </div>
            <p style="color: #6f6f6f; margin-bottom: 0;">En el siguiente formulario, llene los datos solicitados para la creación de una nueva producto.</p><br>
            @if ($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-2" id="condicion-div" style="display: none;">
                        ...
                        <select name="condicion" class="form-control" id="condicion" style="text-transform: uppercase;">
                            <option value="noproducto">90 %</option>
